...
namespace SFA.DAS.Support.Portal.Web.Settings
{
    public class WebConfiguration : IWebConfiguration
    {
        ...
        [JsonRequired]
        public HmrcClientConfiguration HmrcClient { get; set; }
        [JsonRequired]
        public AccountsApiConfiguration AccountsApi { get; set; }
        [JsonRequired]
        public EmployerUsersApiConfiguration EmployerUsersApi { get; set; }
        [JsonRequired]
        public LevySubmissionsApiConfiguration LevySubmissionsApi { get; set; }
        [JsonRequired]
