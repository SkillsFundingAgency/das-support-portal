...
namespace SFA.DAS.Support.Portal.Infrastructure.UnitTests
{
    ...
    public class FormMapperTests
    {
        ...
        public void ItShouldMapTheForm()
        {
            ...
            var exepctedHtml =
                $"<html><head></head><body><form action=\"/resource/challenge?resourceId={id}&amp;key={key}\" method=\"post\"><input name=\"challengeKey\" value=\"{key}\" type=\"hidden\"><input name=\"innerAction\" value=\"\" type=\"hidden\"><input name=\"redirect\" value=\"/api/challenge/response/{id}\" type=\"hidden\"></form></body></html>";
