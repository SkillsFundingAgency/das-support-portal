...
namespace SFA.DAS.Support.Common.Infrastucture.Settings
{
    public class ElasticSearchSettings : ISearchSettings
    {
        ...
        [JsonIgnore]
        public IEnumerable<Uri> ElasticServerUrls { get { 
        ...
        [JsonRequired]
        public bool Elk5Enabled { get; set;}
        [JsonRequired]
        public bool IgnoreSslCertificateEnabled { get; set;}
        [JsonRequired]
        public int IndexShards { get; set;}
        [JsonRequired]
        public int IndexReplicas { get; set;}
        [JsonRequired]
        public int IndexCopyCount { get; set; }
    }
}